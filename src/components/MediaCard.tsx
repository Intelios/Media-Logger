            ...
            <div className="flex items-center gap-2">
              {isRewatch && (
                <div className="relative group/rewatch">
                  <div className="w-8 h-8 rounded-full bg-amber-500/20 border-2 border-amber-500 flex items-center justify-center cursor-pointer">
              ...
              {hasLocalCopy && (
                <div className="relative group/local">
                  <div className="w-8 h-8 rounded-full bg-emerald-500/20 border-2 border-emerald-500 flex items-center justify-center cursor-pointer">
