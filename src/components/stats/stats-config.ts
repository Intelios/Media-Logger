...
export const DISPLAY_MODE_WIDGET_IDS = ["top-lists"] as const;
...
export const STATS_WIDGET_META: Record<StatsWidgetId, StatsWidgetMeta> = {
  ...
  "top-lists": {
    ...
    section: "library",
    title: "Top Lists",
    description: "Most common platforms, franchises, studios, authors, and actresses for the current filters.",
    defaultSize: "full",
    layoutRole: "list",
    heightPreset: "standard",
    defaultVisible: true,
